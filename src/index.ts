...
let dbType = 'sqlserver'; // Default to SQL Server since SQLite is removed
...
// Check if using MySQL
  ...
  // No valid database type specified
  logger.error("Error: Please specify a valid database type (--sqlserver, --postgresql, or --mysql)");
  process.exit(1);
}
